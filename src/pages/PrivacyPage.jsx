          ...
          <div className="max-w-[820px] rounded-[12px] border border-[#e5e0d8] bg-white p-8 md:p-10">
            ...
            <div className="mt-10 space-y-8">
              ...
              <Section title="5. Передача данных третьим лицам">
                <p>Для обработки заявок данные могут передаваться следующим сервисам:</p>
                <ul className="list-disc pl-5 space-y-1">
                  <li><strong>AmoCRM</strong> (ООО «Стрим») — CRM-система для ведения сделок, серверы в РФ</li>
                  <li><strong>Airtable</strong> (Airtable Inc., США) — база данных для хранения заявок</li>
                ...
                <p>
                  Иным третьим лицам данные не передаются, за исключением случаев, предусмотренных законодательством РФ.
                </p>
              </Section>

              <Section title="6. Трансграничная передача данных">
                <p>
                  Часть данных (заявки) передаётся на серверы Airtable Inc., расположенные в США. Передача осуществляется на основании явного согласия субъекта персональных данных, выраженного при отправке формы на сайте, в соответствии со ст. 12 152-ФЗ.
                </p>
              </Section>
              ...
              <Section title="10. Безопасность данных">
                <p>
