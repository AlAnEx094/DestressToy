...
const galleryItems = [
  { label: 'Маскот · welcome kit и подарки', title: 'Медведь-маскот', body: 'Дружелюбная форма для welcome kit, клиентских подарков и корпоративных наборов. Хорошо смотрится в нейтральных и фирменных цветах.', image: '/images/gallery/bear.webp', alt: 'Белый медведь-маскот — кастомный антистресс бренд-объект для welcome kit и корпоративных подарков' },
  { label: 'Маскот · digital и IT', title: 'Кот-робот', body: 'Технологичный персонаж для IT, финтеха и digital-команд. Подходит для мерча, который хочется оставить на рабочем столе.', image: '/images/gallery/cat.webp', alt: 'Чёрный кот-робот — кастомный антистресс маскот для IT-компании и брендированного мерча' },
  { label: 'Символ · мероприятия и стенды', title: 'Осьминог-маскот', body: 'Узнаваемая форма с высокой тактильностью. Легко ассоциируется с брендом — для event-стендов и раздатки на мероприятиях.', image: '/images/gallery/octopus.webp', alt: 'Голубой осьминог-маскот — мягкий кастомный антистресс для выставок, событий и промо-раздачи' },
  { label: 'Персонаж · спецпроекты', title: 'Динозавр', body: 'Мягкий персонаж для запусков, детских направлений и брендов с ярким характером. Работает как запоминающийся бренд-объект.', image: '/images/gallery/dinosaur.webp', alt: 'Мятный динозавр — кастомный мягкий антистресс персонаж для бренд-объекта и промо-кампании' },
  { label: 'Промо · выставки и рассылки', title: 'Утёнок', body: 'Позитивный образ для промо-акций, рассылок и подарков партнёрам. Быстро считывается и вызывает эмоциональный отклик.', image: '/images/gallery/duck.webp', alt: 'Жёлтый утёнок — брендированный антистресс для промо-рассылок, выставок и корпоративных подарков' },
  { label: 'Форма · wellness и забота', title: 'Облачко', body: 'Спокойная минималистичная форма для HR, wellness-программ и заботливых клиентских коммуникаций.', image: '/images/gallery/cloud.webp', alt: 'Мягкое облачко — кастомный антистресс для HR, wellness-программ и бренд-коммуникаций' },
  { label: 'Кастом · необычная форма', title: 'Арбуз', body: 'Яркая предметная форма для специальных кампаний, сезонных запусков и брендов, которым важно выделиться с первого взгляда.', image: '/images/gallery/watermelon.webp', alt: 'Арбуз-персонаж — нестандартный кастомный антистресс бренд-объект для промо-кампании' },
