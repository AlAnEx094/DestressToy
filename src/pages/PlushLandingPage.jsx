    ...
    <main className="bg-[#151716] text-[#151716]">
      ...
      <section id="gallery" className="bg-[#ebe5dd] py-10 md:py-16 xl:py-24">
        <Container>
              ...
              >
                <button type="button" onClick={() => setGalleryLightboxItem(item)} className="block w-full text-left cursor-pointer">
                  ...
                  <div className="p-3 md:p-6">
                    <p className="mb-1 hidden text-xs uppercase tracking-widest text-[#9b7be8] md:block">
                      {item.label}
                    </p>
          ...
          <GalleryLightbox item={galleryLightboxItem} accentColor="#9b7be8" onClose={() => setGalleryLightboxItem(null)} />
        </Container>
      </section>
